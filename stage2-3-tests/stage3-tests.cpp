...
#include "stage2-3-tests/earlywarning-uses-dynamic-allocation.h" // ensure dynamic allocation
														   
#include "stage2-3-tests/earlywarning-use-newdelete-ops.h"       // assure new[] and delete[] are being used
																 
#include "stage2-3-tests/earlywarning-detect-memory-leak.h"      // memory leaks?
