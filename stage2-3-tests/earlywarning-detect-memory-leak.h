...
class MemoryObserver {
    ...
    public:
        ...
        static void reset(){ observers = 0; }
};

static inline std::ostream& operator<<( std::ostream& os, const MemoryObserver& )
{
	return os << "mo" ;
}
...
TEST(ProjectRequirements, DetectMemoryLeak) {
	using namespace detect_memory_leak;
